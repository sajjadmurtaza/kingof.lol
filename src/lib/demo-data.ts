...
const DEMO_CATEGORIES = [
  ...
  { id: "cat-empty", slug: "empty", name: "Empty", emoji: "📭", sortOrder: 99 },
];
...
const ALL_PRODUCTS_RAW = [
  {
    ...
    slug: "neuralforge",
    name: "NeuralForge",
    tagline: "Train models in minutes, not months",
  ...
  },
  {
    ...
    slug: "promptpilot",
    name: "PromptPilot",
    tagline: "Your AI copilot for prompt engineering",
  ...
  },
  {
    ...
    slug: "dataweave-ai",
    name: "DataWeave AI",
    tagline: "Automated data pipelines with AI",
    url: "https://dataweave.ai",
    totalBid: 8500,
    status: "approved",
    categoryId: "cat-ai",
    categorySlug: "ai",
...

  {
    ...
    slug: "payflow",
    name: "PayFlow",
    tagline: "Global payments in one API call",
  ...
  },
  {
    ...
    slug: "lendsmart",
    name: "LendSmart",
    tagline: "AI-powered lending decisions",
    url: "https://lendsmart.co",
    totalBid: 9000,
    status: "approved",
    categoryId: "cat-fintech",
    categorySlug: "fintech",
  ...
  {
    id: "p9",
    slug: "invoiceninja-pro",
    name: "InvoiceNinja Pro",
    tagline: "Invoicing that practically does itself",
    url: "https://invoiceninja.pro",
    totalBid: 5500,
    status: "approved",
    categoryId: "cat-fintech",
    categorySlug: "fintech",
...

  {
    ...
    slug: "codeship",
    name: "CodeShip",
    tagline: "Deploy anything in 30 seconds",
    url: "https://codeship.dev",
    totalBid: 18000,
    status: "approved",
  ...
  },
  {
    ...
    slug: "bughunter",
    name: "BugHunter",
    tagline: "AI finds your bugs before users do",
    url: "https://bughunter.io",
    totalBid: 11000,
    status: "approved",
    categoryId: "cat-devtools",
    categorySlug: "devtools",
  ...
  },
  {
    ...
    slug: "apivault",
    name: "APIVault",
    tagline: "API monitoring and testing suite",
    url: "https://apivault.io",
    totalBid: 4000,
    status: "approved",
    categoryId: "cat-devtools",
    categorySlug: "devtools",
  ...
  },
  {
    ...
    slug: "gitflow-pro",
    name: "GitFlow Pro",
    tagline: "Git workflows on autopilot",
    url: "https://gitflow.pro",
    totalBid: 2500,
    status: "approved",
    categoryId: "cat-devtools",
    categorySlug: "devtools",
  ...
  },
  {
    ...
    slug: "colormind",
    name: "ColorMind",
    tagline: "AI-generated color palettes",
  ...
  },
  {
    ...
    slug: "mockupmagic",
    name: "MockupMagic",
    tagline: "3D product mockups in seconds",
    url: "https://mockupmagic.com",
    totalBid: 5000,
    status: "approved",
    categoryId: "cat-design",
    categorySlug: "design",
  ...
  },
  {
    ...
    slug: "fontforge-ai",
    name: "FontForge AI",
    tagline: "Custom fonts generated by AI",
    url: "https://fontforge.ai",
    totalBid: 2000,
    status: "approved",
    categoryId: "cat-design",
    categorySlug: "design",
...

  {
    ...
    slug: "metricstream",
    name: "MetricStream",
    tagline: "Real-time business analytics",
    url: "https://metricstream.io",
    totalBid: 13000,
    status: "approved",
    categoryId: "cat-saas",
    categorySlug: "saas",
  ...
  },
  {
    ...
    slug: "formwizard",
    name: "FormWizard",
    tagline: "Beautiful forms with zero code",
    url: "https://formwizard.io",
    totalBid: 4500,
    status: "approved",
    categoryId: "cat-saas",
    categorySlug: "saas",
  ...
  },
  {
    ...
    slug: "chatdesk",
    name: "ChatDesk",
    tagline: "Customer support on autopilot",
    url: "https://chatdesk.ai",
    totalBid: 1500,
    status: "approved",
    categoryId: "cat-saas",
    categorySlug: "saas",
...

  {
    ...
    slug: "mindspace",
    name: "MindSpace",
    tagline: "AI-guided meditation and therapy",
    url: "https://mindspace.health",
    totalBid: 11000,
    status: "approved",
  ...
  },
  {
    ...
    slug: "nutriscan",
    name: "NutriScan",
    tagline: "Scan food, know nutrition instantly",
