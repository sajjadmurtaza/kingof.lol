      ...
      >
        ...
        {categoryName && (
          <>
            ...
            <div style={{ display: "flex", color: "#737373", fontSize: 18, fontWeight: 500 }}>
              {categoryName}
            </div>
          </>
        )}
      ...
      >
        {rank > 0 && (
          <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
            <span
              style={{ display: "flex", color: isKing ? "#fbbf24" : "#737373", fontWeight: 700 }}
            >
              #{rank}
            </span>
        ...
        {totalBid > 0 && (
          <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
            <span style={{ display: "flex", color: "#fbbf24", fontWeight: 700 }}>
              ${bidDollars}
            </span>
